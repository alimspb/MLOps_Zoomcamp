...
if __name__ == '__main__':
    # This ensures the script doesn't fail if angle brackets are accidentally included in the path
    import sys
    if len(sys.argv) > 1:
        # Remove any angle brackets from arguments
        sys.argv = [arg.replace('<', '').replace('>', '') for arg in sys.argv]
    run_data_prep()
